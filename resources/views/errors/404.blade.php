...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan - {{ setting('nama_warung', 'Soto Seger Boyolali Pak Antok') }}</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon { width:72px; height:72px; border-radius:50%; background:#FFF3E0; display:flex; align-items:center; justify-content:center; margin:0 auto 20px; }
        h1 { font-size:48px; font-weight:800; color:#FF8C42; margin-bottom:4px; }
...
<body>
    <div class="card">
        <div class="icon">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#FF8C42" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M12 3a9 9 0 100 18 9 9 0 000-18z"/></svg>
        </div>
        <h1>404</h1>
        <h2>Halaman Tidak Ditemukan</h2>
        <p>Halaman yang kamu cari tidak ada atau sudah dipindahkan. Periksa kembali URL atau kembali ke beranda.</p>
